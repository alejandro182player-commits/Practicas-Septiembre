public class Alumnos
{
    ...
    {
        Console.WriteLine($"Nombre: {Nombre}, Español: {Calificaion1}, Matematicas: {Calificacion2}, Ingles: {Calificacion3}");   
    }
...
public class Calificaciones
{
    ...
    public void Registrar()
    {
        ...
        float Calificacion_1 = Console.ReadLine();
        Console.WriteLine("Calificacion de Matematicas:");
        float Calificacion_2 = Console.ReadLine();
        Console.WriteLine("Calificacion de Ingles:");
        float Calificacion_3 = Console.ReadLine();
